...
from mininet.topo import Topo #added this line (Fix 1)
...
class FinalTopol( Topo ):
    ...
    def __init__( self ):
        ...
        serverHost = self.addHost( 'S1' ) #added server (Fix 2)
        ...
        self.addLink( leftSwitch, rightSwitch ) #Change rightSwitch to leftSwitch (Fix 3)
